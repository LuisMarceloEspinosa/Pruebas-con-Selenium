...
class ApplicationTest {
  ...
  /*
   * 1. Etiqueta + ID: Encuentra el cuadro de búsqueda en Google por su etiqueta y
   * ID.
   * 
   * 2. Etiqueta + Clase: Encuentra y haz clic en el primer enlace en la barra de
   * navegación en la página de inicio de GitHub. 3. Etiqueta + Atributo:
   ...
   * página de inicio de sesión de LinkedIn. 5. Etiqueta + Clase: Encuentra y haz
   * clic en el primer artículo "Trending" en Medium. 6. Etiqueta + Clase:
   * Encuentra y haz clic en el enlace "Contact" en el pie de página del sitio
   * Stack Overflow. 7. Etiqueta + ID: Encuentra y muestra la descripción del
   * primer producto en la página de inicio de Amazon.
   * 
   * 8. Etiqueta + Atributo: Encuentra y muestra el título del primer video en la
   ...
   * 
   * 2. Navega a una lista de reproducción en YouTube y muestra el título de los
   * primeros 5 videos.
   * 
   * 3. Navega a Amazon, realiza una búsqueda, luego filtra los resultados por una
   * categoría específica. 4. Navega a una página de Wikipedia, selecciona una
   * sección y muestra las referencias utilizadas en esa sección.
   * 
   * 5. Navega a Pixabay, realiza una búsqueda de imágenes y explora la primera
   * galería.
   * 
   * 6. Navega a Best Buy, busca un producto y verifica si su precio está por
   * debajo de un valor determinado. 7. Navega a FlightStats, rastrea un vuelo por
   * su número y muestra el estado.
   * 
  ...
  void Ejercicio1() {
    ...
    // Realizar una acción en el cuadro de búsqueda, por ejemplo, escribir
    // "Selenium"
  ...
  void Ejercicio4() throws InterruptedException {
    ...
    WebElement searchBox = driver.findElement(By.cssSelector(
        "a.font-sans[href=\"https://www.linkedin.com/uas/request-password-reset?trk=homepage-basic_forgot_password\"]"));
...
void practicaFluentWait(){
    ...
    WebElement parrafo = wait.until(new Function<WebDriver, WebElement>() {
        public WebElement apply(WebDriver driver) {
