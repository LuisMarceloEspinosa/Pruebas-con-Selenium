...
class ApplicationTest {
  ...
  // navegación en la página de inicio de GitHub.
  // 3. Etiqueta + Atributo: Encuentra el botón "Sign Up" en la página de inicio
  // de Twitter.
  // 4. Etiqueta + Clase + Atributo: Encuentra el enlace "Forgot password?" en la
  // página
  // de inicio de sesión de LinkedIn.
  // 5. Etiqueta + Clase: Encuentra y haz clic en el primer
  // artículo "Trending" en Medium
  // 6. Etiqueta + Clase: Encuentra y haz clic en el enlace
  // "Contact" en el pie de página del sitio Stack Overflow.
  // 7. Etiqueta + ID: Encuentra y
  // muestra la descripción del primer producto en la página de inicio de Amazon.
  ...
  /*
   * Ejercicio integrador de selectores 7, 1. Navegar a la página de Wikipedia de
   * una ciudad,
